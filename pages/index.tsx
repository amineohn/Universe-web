      ...
      <FadeIn className="flex flex-col justify-center px-8 my-20 overflow-hidden">
        <div className="flex flex-col items-start justify-center max-w-2xl mx-auto mb-16 dark:text-white">
          <div className="flex-col items-center">
            <h1 className="pb-2 text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-t from-coolneutral-900 to-warmneutral-600 dark:bg-gradient-to-bl dark:from-neutral-50 dark:to-neutral-100">
              Template NextJS
            </h1>
            <div className="mb-8">
              <p className="mb-4 bg-clip-text bg-gradient-to-tl from-neutral-700 via-neutral-900 to-black dark:bg-gradient-to-tl dark:from-neutral-50 dark:via-neutral-100 dark:to-white">
                Simple template with NextJS, Tailwind, React ALPHA 18,
                TypeScript
              </p>
            </div>
            <div className="w-full overflow-hidden metric-card max-w-72 bg-neutral-100 dark:bg-white bg-opacity-50 dark:bg-opacity-20 rounded-2xl p-4">
              <div className="flex items-center font-bold text-neutral-900 dark:text-neutral-100">
                API Hello
              </div>
              <p className="mt-2 text-sm font-medium text-neutral-800 spacing-sm dark:text-white">
                {data ? (
            ...
            <div className="flex flex-col w-full overflow-y-scroll space-y-2">
              <div className="grid w-full grid-cols-1 gap-4 my-2 sm:grid-cols-2">
                ...
                >
                  <div className="w-full overflow-hidden transition transform metric-card max-w-72 hover:scale-95 bg-neutral-100 dark:bg-white bg-opacity-50 dark:bg-opacity-20 rounded-2xl p-4">
                    <div className="flex items-center font-bold text-neutral-900 dark:text-neutral-100">
                      NextJS
                    </div>
                    <p className="mt-2 text-sm font-medium text-neutral-800 spacing-sm dark:text-white">
